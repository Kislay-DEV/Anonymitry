...
import { LogOut, Upload, MessageSquare, Camera, Trash } from 'lucide-react';
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mt-8 flex flex-col gap-8">
          <div className="bg-slate-800 rounded-lg shadow p-6 w-3/5">
            <h2 className="text-lg font-semibold text-white mb-4">Create Posts</h2>
            <form onSubmit={handleSubmit(onSubmit)} method="post">
              <Textarea
                type='text'
                id='post'
                placeholder='Create Posts'
                className="w-full h-16 bg-slate-900/50 text-white rounded-lg pr-4 py-3 border border-slate-700 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all outline-none placeholder:text-slate-500"
